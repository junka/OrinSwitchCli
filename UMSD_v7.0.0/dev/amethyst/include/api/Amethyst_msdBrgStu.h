...
#ifndef __Amethyst_msdBrgStu_h
#define __Amethyst_msdBrgStu_h
...
/*
 * typedef: enum AMETHYST_PORT_STP_STATE
 *
 * Description: Enumeration of the port spanning tree state.
 *
 * Enumerations:
 *   AMETHYST_MSD_PORT_DISABLE    - port is disabled.
 *   AMETHYST_MSD_PORT_BLOCKING   - port is in blocking/listening state.
 *   AMETHYST_MSD_PORT_LEARNING   - port is in learning state.
 *   AMETHYST_MSD_PORT_FORWARDING - port is in forwarding state.
 */
...
#endif
/*
 *  typedef: struct AMETHYST_MSD_STU_ENTRY
 *
...
{
    MSD_U16                sid;
    AMETHYST_MSD_PORT_STP_STATE    portState[MSD_MAX_SWITCH_PORTS];
} AMETHYST_MSD_STU_ENTRY;
