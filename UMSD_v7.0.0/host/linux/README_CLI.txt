              ...
              Telnet Command Line Interface of UMSD (Unified Marvell SOHO/Automotive Driver) 
             ================================================================================
Contents:
...
-------------------------------
	...
	3.3)Build the test program
		Switch to host/linux floder and run command <make>
...
-------------------------------
	...
	4.2)To run the test program 
		4.2.1) Start the program with interactive interface
			   <sudo ./MCLI>
	    4.2.2) Start the program with configure file
			   <sudo ./MCLI -f umsd.cfg>
	
5) Test Display on screen
-------------------------------	
	5.1) Start the program with interactive interface
		Interface List:
			0 : SMI Interface
			1 : SMI Multi-Chip
			2 : RMU Interface
		...
		SMI Protocol select:
			0: MDIO(Clause22)
			1: XMDIO(Clause45), only support by Amethyst/Oak/Spruce...
		Please select one protocol: 0
